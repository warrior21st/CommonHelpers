...
namespace CommonHelpers.Helpers
{
    ...
    public static class NetHelper
    {
        ...
        /// <returns></returns>
        public static async Task<string> GetAsync(string url, Dictionary<string, object> paramsDic, int timeoutSeconds = 60, string contentType = null, string responseEncoding = "UTF-8")
        {
        ...
        /// <returns></returns>
        private static HttpClient GetClient(string method, int timeoutSeconds, Dictionary<string, object> headers = null)
        {
